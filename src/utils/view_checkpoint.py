...
用法:
    python -m src.utils.view_checkpoint <checkpoint_path>

示例:
    python -m src.utils.view_checkpoint checkpoints/vae-dnn-cvae/official/cvae_dense_fullgrid.ckpt
    python -m src.utils.view_checkpoint checkpoints/vae-dnn-cvae/official/dnn_edge_fullgrid.ckpt
    python -m src.utils.view_checkpoint checkpoints/vae-dnn-cvae/official/vae_incept_edges.ckpt
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python -m src.utils.view_checkpoint <checkpoint_path>")
        sys.exit(1)
