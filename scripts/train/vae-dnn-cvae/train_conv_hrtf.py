...
from src.dataset.hrtf import SonicomDataSet,SonicomDataSetConvHRTF
...
def main(args):
    ...
    # 创建数据集
    train_dataset = SonicomDataSetConvHRTF(
    ...
    test_dataset = SonicomDataSetConvHRTF(
    ...
    print("Shape of hrtfs:", batch_train_test["hrtf"].shape)  
    # 输出为: torch.Size([batch_size=4, 793, 108])
    ...
    model.example_input_array = batch_example["hrtf"]
    # 训练循环
    num_epochs = 480*5
    '''
