...
class Mlp(nn.Module):
    """
    MLP as used in Vision_Transformer, MLP-Mixer and related networks
    """
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 ...
                 act_layer=None):
        #TRANS BLOCK(ATTENTION):12  MLP:4X768=3072  
        """
        Args:
