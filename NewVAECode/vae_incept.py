...
## VAE
class VAE(nn.Module):
    def __init__(self, use_inception, repeat_per_block, latent_size):
        super().__init__()
        # latent features
        ...
        self.fc_rep = nn.Linear(self.latent_size, 256)
        # Decoder
    ...
    def sampling(self):
        ...
        z = torch.randn(16, self.latent_size)
        z = self.fc_rep(z)
        # decode
